...
// @author       You
// @match        http://intranet.jira.es/browse/ACC-644?jql=project%20in%20(NET%2C%20NeT10-Bugs)%20AND%20priority%20in%20(%22Muy%20baja%22)%20AND%20statusCategory%20in%20(%22To%20Do%22%2C%20%22In%20Progress%22)%20ORDER%20BY%20priority%20DESC%2C%20updated%20DESC
// @grant        none
// ==/UserScript==
...
function createMenu(numBloqueantes){
    ...
    $.each(tickets, function(key, value){
        botones += '<button class="aui-button aui-button-primary" style="margin:0;background-color:'+value['color']+'"><a style="padding:0" href="'+value['ruta']+'" title="Ver bugs bloqueantes">'+(value['cantidad']>=50?"50+":value['cantidad'])+'</a></button>';
    });
    ...
    $("#header nav .aui-header-primary ul").append(botones);
}